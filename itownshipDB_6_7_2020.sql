...
insert  into `expense`(`member_id`,`e_id`,`e_amount`,`e_type`,`e_receiver`,`e_category`,`e_date`,`e_receipt`,`e_notes`) values (1,841,40000,'spend','hhh','Fashion','2016-02-26','h','h'),(1,842,10000,'spend','Kashish Patel','Medical','2016-12-29','Capture.JPG','He will give me back after two months :p'),(1,843,2,'spend','Ronak janani','Bike','2015-10-29','','Review 1'),(1,844,2,'spend','Datt','Finance','2014-11-30','','Review 2'),(1,845,1,'spend','Ronak Janani','Dining','05-05-1995','','FSJEDNJ');
...
insert  into `tasks`(`tsk_id`,`mem_id`,`chr_id`,`task_desc`,`priority`,`progress`,`deadline`) values (1,6,1,'Pump Manufacturation','Low',0,'15'),(2,8,1,'Water Supply Manufacturation','High',0,'30'),(3,9,1,'New Task','Medium',0,'30'),(4,9,1,'New Task','Medium',0,'30'),(5,7,1,'New Task 2','Medium',10,'50'),(6,7,1,'New Task 2','Medium',10,'50'),(7,7,1,'New Task 2','Medium',10,'50'),(8,9,1,'Sulay Pakdayo','Low',10,'50');
