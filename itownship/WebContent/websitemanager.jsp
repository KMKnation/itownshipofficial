   ...
   <!-- --Header Starts here  -->
    ...
    --->
		...
		<div id="containall">
			...
			<div id="pic11">
				<a href="#"><img src="<%=request.getContextPath() %>/Resources/images/ui.JPG" /></a>
			</div>
			<div id="features11">
				<span class="feat11">
					Features
				...
				<ul class="feat22">
				<li>Space on a website is practically limitless, and it can hold text, images, audio, and video, making it more versatile than any other marketing platform in the world.
				</li><br />
						<li>Handle online marketing projects ranging from SEO to social media marketing.</li><br />
				
					<li>Ensure website functionality and perform software updates.</li>
					<br />
				
					<li>Monitor, assess, and report on website performance.</li><br />
					<li>Ensure domain registration and hosting are current.</li><br />
					<li>Develop and/or update content.</li><br />
