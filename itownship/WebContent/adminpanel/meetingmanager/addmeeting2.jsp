...
<body>
	<div id="addmeeting">
		<div id="add-head">Meeting Info</div>
		<div id="add-data">
			<div id="forminputs">
				<form action="add3" method="get">
				<h4>MEETING NAME</h4>
				<input type="text" name="m_name" placeholder="name" value="${name }"/>
			</div>
		</div>
		...
		<div id="add-data">
			<div id="forminputs">
				<h4>ABOUT</h4>
				<input type="text" name="m_about"  placeholder="Meeting Description"/>
			</div>
		</div>
		...
		<div id="add-data">
			<div id="forminputs">
				<h4>PLACE</h4>
				<input type="text" name="m_place" placeholder="Type Meeting Location"/>
			</div>
		</div>
		...
		<div id="add-data">
			<div id="forminputs">
				<h4>DATE</h4>
				<input type="text" name="m_date" placeholder="Type Meeting Location"/>
			</div>
		</div>
