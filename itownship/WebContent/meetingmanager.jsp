...
<!-- --Header Starts here  -->
	...
	<div id="containall">
			...
			<div id="pic11">
				<a href="#"><img src="<%=request.getContextPath() %>/Resources/images/meetingmanager.JPG" /></a>
			</div>
			<div id="features11">
				<span class="feat11">
					Features
				...
				<ul class="feat22">
					<li>Manager roles can be created for Office Staff.</li>
					<br />
					<li>Discuss Facility Management Issues and other Improvement Areas within the Admin Team.</li><br />
					<li>Close the Meeting and share the Report by Email to all Invitees.</li><br />
					<li>Quickly Create Recurring Tasks and monitor tasks and assign them.</li><br />
				</ul>
			</div>
	</div>
