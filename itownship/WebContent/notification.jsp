...
<!-- --Header Starts here  -->
    ...
    --->
			...
			<div id="pic11">
				<a href="#"><img src="<%=request.getContextPath() %>/Resources/images/notification.jpg" /></a>
			</div>
			<div id="features11">
				<span class="feat11">
					Features
				...
				<ul class="feat22">
					<li>Residents can pay their dues online through Payment Gateway provided by PayU.</li>
					<br />
					<li>Instant E-Receipts is generated and their Dues get cleared off.</li><br />
					<li>Facility Booking, Move in/out charges, Festival ticketing can all be done easily through Payment Gateway.</li><br />
					<li>Verify if all documents have been submitted by member and generate defaulters report.</li><br />
				</ul>
			</div>
	</div>
